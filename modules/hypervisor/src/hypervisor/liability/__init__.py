"""
Liability Matrix — directed graph of voucher→vouchee relationships.

Tracks who vouches for whom within a session, with bond amounts,
cascade detection, and session-scoped isolation.
"""
