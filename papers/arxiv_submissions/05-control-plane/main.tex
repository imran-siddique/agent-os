...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{constraint_graphs.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{results_chart.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{ablation_chart.png}
