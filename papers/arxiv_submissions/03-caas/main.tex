...
\begin{figure}[t]
    \centering
    \includegraphics[width=0.9\columnwidth]{fig2_context_triad.png}
...
\begin{figure}[t]
    \centering
    \includegraphics[width=\columnwidth]{fig3_ablation_results.png}
...
\begin{figure}[t]
    \centering
    \includegraphics[width=\columnwidth]{fig4_routing_latency.png}
